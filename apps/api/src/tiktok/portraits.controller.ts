...
@Controller('tiktok/accounts/:accountId/portraits')
...
export class PortraitsController {
  ...
  list(@Param('accountId') accountId: string) {
    return this.media.list(accountId, 'portraits');
  }
  ...
  upload(
    ...
    return this.media.upload(accountId, 'portraits', file);
  }
  ...
  bulkRemove(
    ...
    return this.media.bulkRemove(accountId, 'portraits', dto.ids);
  }
  ...
  remove(
    ...
    return this.media.remove(accountId, 'portraits', assetId);
  }
}
